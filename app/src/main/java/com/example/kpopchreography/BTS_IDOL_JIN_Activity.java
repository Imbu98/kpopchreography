...
public class BTS_IDOL_JIN_Activity extends YouTubeBaseActivity {
    ...
    private static String videoId = "iZaTdut708M";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bts_idol_fancam_jin);
