...
public class BTS_IDOL_SUGAR_Activity extends YouTubeBaseActivity {
    ...
    private static String videoId = "3DqDBIuZPEw";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bts_idol_fancam_sugar);
