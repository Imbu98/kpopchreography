...
public class BTS_IDOL_JIMIN_Activity extends YouTubeBaseActivity {
    ...
    private static String videoId = "UPqhyR-WYJQ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bts_idol_fancam_jimin);
