...
public class BTS_IDOL_JHOPE_Activity extends YouTubeBaseActivity {
    ...
    private static String videoId = "HDeZKlLHlp4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bts_idol_fancam_jhope);
