...
public class BTS_IDOL_RM_Activity extends YouTubeBaseActivity {
    ...
    private static String videoId = "xL6MVJnSPcE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bts_idol_fancam_rm);
