...
public class BTS_IDOL_STAGE_Activity extends YouTubeBaseActivity {
    ...
    private static String videoId = "CfZEph5TsVk";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bts_idol_stage);
