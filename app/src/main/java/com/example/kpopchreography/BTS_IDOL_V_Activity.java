...
public class BTS_IDOL_V_Activity extends YouTubeBaseActivity {
    ...
    private static String videoId = "Dv3EHMziAmY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bts_idol_fancam_v);
